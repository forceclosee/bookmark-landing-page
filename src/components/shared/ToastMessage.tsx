...
import "@components/shared/ToastMessage.css";

type Props = ComponentProps<"div"> & {
	message: string | null;
};

export default function ToastMessage({ message, ...props }: Props) {
	return (
		<div className="toast-message" {...props}>
			<svg
				className="toast-message__icon"
				aria-hidden="true"
			...
			<span className="toast-message__header">Thanks for subscribing</span>
			<span className="toast-message__text" data-testid="toast-message-text">
				{message}
			</span>
		</div>
	);
